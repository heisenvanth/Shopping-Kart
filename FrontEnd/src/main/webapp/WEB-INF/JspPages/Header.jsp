...
<li><a href="<c:url value="cart/getcart" />">Cart</a></li>
</c:if>
</c:if>
...
<li><a href="all/getregistrationform"><i class="glyph glyphicon-login"></i>Sign In</a></li>
<li><a href="login"><i class="glyph glyphicon-login"></i>Login here</a></li>
...
<li><a href="<c:url value="logout" />"> <span class="glyph glyphicon-user"></span> Sign Out</a><li>
...
<li><a href="<c:url value="j_spring_security_logout" />"> <span class="glyph glyphicon-user"></span> Sign Out</a><li>
</c:if>	
</c:if>
